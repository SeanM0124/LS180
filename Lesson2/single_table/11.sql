...
takes to prepare one item. Assume that whoever is preparing the food is being paid $13 an hour.
List the most profitable items first. Keep in mind that prep_time is represented in minutes and ingredient_cost
...
SELECT round(prep_time/60.0 * 13.0, 2) AS labor --how to subquery this to reduce redundency?
       SELECT item, menu_price, ingredient_cost,
